...
{
    public partial class SolarizadoDialog : Form
    {
        ...
        public SolarizadoDialog(Bitmap image)
        {
            InitializeComponent();
        ...
        private void aplicarFiltro()
        {
            if (originalImage != null)
            {
                ...
                ImageToProcess = clase.AplicarSolarizado(new Bitmap(originalImage), (int)numericUpDownValor.Value,invertir.Checked);
                pictureBoxPreview.Image = ImageToProcess;
            }
        }

        private void invertir_CheckedChanged(object sender, EventArgs e)
        {
            aplicarFiltro();
        }
    }
