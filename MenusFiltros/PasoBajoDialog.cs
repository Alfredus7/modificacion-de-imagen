...
{
    public partial class PasoBajoDialog : Form
    {
        public FiltrosBordesSuavizado clase = new FiltrosBordesSuavizado();
        

        public PasoBajoDialog(Bitmap image)
        {
            InitializeComponent();
        ...
        private void aplicarFiltro()
        {
            if (originalImage != null)
            {
                ...
                ImageToProcess = clase.AplicarPasoBajo(new Bitmap(originalImage), trackBarSigma.Value, trackBarSize.Value);
